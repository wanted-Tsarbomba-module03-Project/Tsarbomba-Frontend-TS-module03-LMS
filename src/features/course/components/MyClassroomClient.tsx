  ...
  return (
    <section className="border border-border-light rounded-lg p-6">
      ...
      {items.length === 0 ? (
        ...
        <div className="flex gap-4 overflow-x-auto pb-2 -mx-1 px-1 sm:mx-0 sm:px-0 sm:grid sm:grid-cols-2 md:grid-cols-4 sm:gap-4 sm:overflow-x-visible sm:overflow-y-auto sm:max-h-[300px] sm:pb-0 sm:pr-1">
          {items.map((e) => (
            <CourseCard
